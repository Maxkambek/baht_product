...
from accounts.models import PaymentAccounts
...
class ReceiptCreate(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        res = client_receipt._receipts_create(123, order_amount, f'{order_id}', title='Baxtli ayol kursi',
                                              code='21331213',
        ...
        try:
            ...
            print(pay)
            paid = PaymentAccounts.objects.create(
                amount=order_amount,
